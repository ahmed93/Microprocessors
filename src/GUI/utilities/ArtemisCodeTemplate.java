...
public class ArtemisCodeTemplate extends StaticCodeTemplate {
	 ...
	 */
	public ArtemisCodeTemplate(String id, String beforeCaret,
			String placeholder, String afterCaret) {
	...
	public void invoke(RSyntaxTextArea textArea) throws BadLocationException {
		...
		textArea.moveCaretPosition(p0 + beforeText.length()
				+ placeholder.length());
	}
	...
	public String toString() {
		return "[ArtemisCodeTemplate: id=" + getID() + ", text="
				+ getBeforeCaretText() + "|" + getPlaceholder() + "|"
				+ getAfterCaretText() + "]";
	}
