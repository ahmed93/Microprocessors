...
"R5" |
"R6" |
"R7"		{ addToken(Token.RESERVED_WORD_2); }
...
"RET" |
"SUB" |
"SW"		{ addToken(Token.DATA_TYPE); }

	/* Functions */
	"#data:" |
"#instructions:"		{ addToken(Token.FUNCTION); }
...
<DOCCOMMENT> {
	...
	{DocCommentEnd}			{ yybegin(YYINITIAL); addToken(start,zzStartRead+3-1, Token.COMMENT_DOCUMENTATION); }
	"*"						{}
